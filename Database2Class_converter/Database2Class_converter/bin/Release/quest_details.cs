...
namespace WoWAppVisual.Database
{
	class Quest_details
	{
		...
		public Quest_details(int _ID, int _Emote1, int _Emote2, int _Emote3, int _Emote4, int _EmoteDelay1, int _EmoteDelay2, int _EmoteDelay3, int _EmoteDelay4, int _VerifiedBuild)
		{
			ID = _ID;
			Emote1 = _Emote1;
			Emote2 = _Emote2;
		...
		public void delete()
		{
			...
			cmd.CommandText = "DELETE FROM quest_details WHERE ID = @ID AND Emote1 = @Emote1 AND Emote2 = @Emote2 AND Emote3 = @Emote3 AND Emote4 = @Emote4 AND EmoteDelay1 = @EmoteDelay1 AND EmoteDelay2 = @EmoteDelay2 AND EmoteDelay3 = @EmoteDelay3 AND EmoteDelay4 = @EmoteDelay4 AND VerifiedBuild = @VerifiedBuild;";
		...
		public void update()
		{
			conn.Open();
			MySqlCommand cmd = new MySqlCommand("", conn);
			cmd.CommandText = "UPDATE quest_details SET ID = @newID, Emote1 = @newEmote1, Emote2 = @newEmote2, Emote3 = @newEmote3, Emote4 = @newEmote4, EmoteDelay1 = @newEmoteDelay1, EmoteDelay2 = @newEmoteDelay2, EmoteDelay3 = @newEmoteDelay3, EmoteDelay4 = @newEmoteDelay4, VerifiedBuild = @newVerifiedBuild WHERE ID = @ID AND Emote1 = @Emote1 AND Emote2 = @Emote2 AND Emote3 = @Emote3 AND Emote4 = @Emote4 AND EmoteDelay1 = @EmoteDelay1 AND EmoteDelay2 = @EmoteDelay2 AND EmoteDelay3 = @EmoteDelay3 AND EmoteDelay4 = @EmoteDelay4 AND VerifiedBuild = @VerifiedBuild;";
