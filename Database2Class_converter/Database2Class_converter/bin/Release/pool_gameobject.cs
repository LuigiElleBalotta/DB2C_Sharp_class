...
namespace WoWAppVisual.Database
{
	class Pool_gameobject
	{
		...
		public Pool_gameobject(int _guid, int _pool_entry, float _chance, string _description)
		{
			guid = _guid;
		...
		public void delete()
		{
			...
			cmd.CommandText = "DELETE FROM pool_gameobject WHERE guid = @guid AND pool_entry = @pool_entry AND chance = @chance AND description = @description;";
		...
		public void update()
		{
			conn.Open();
			MySqlCommand cmd = new MySqlCommand("", conn);
			cmd.CommandText = "UPDATE pool_gameobject SET guid = @newguid, pool_entry = @newpool_entry, chance = @newchance, description = @newdescription WHERE guid = @guid AND pool_entry = @pool_entry AND chance = @chance AND description = @description;";
